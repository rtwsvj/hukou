...
reported privately through the repository's GitHub private reporting form:

<https://github.com/rtwsvj/hukou/security/advisories/new>

Prefix the report title with `[Conduct]`. Do not include a conduct report in
a public issue or Discussion. If the private form is unavailable and the
behavior also violates GitHub policy, use GitHub's platform reporting tools.

All complaints will be reviewed and investigated promptly and fairly.
Community leaders will respect the privacy and security of the reporter.
Anyone with a conflict of interest must recuse themselves from handling the
report.
